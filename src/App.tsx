        ...
        <div style={{ textAlign: "center", zIndex: 1, width: "100%", maxWidth: 720 }}>
          ...
          <div style={{ display: "flex", gap: "1.5rem", justifyContent: "center", marginTop: "2.5rem" }}>
            {[{ icon: "in", href: "https://www.linkedin.com/in/shivacharanreddy-admala/" }, { icon: "✉", href: "mailto:charan.shiva567@gmail.com" }].map((s) => (
              <a key={s.href} href={s.href} target="_blank" rel="noreferrer" style={{ color: "#475569", fontSize: "1.4rem", textDecoration: "none", transition: "color 0.3s" }} onMouseEnter={(e) => (e.currentTarget.style.color = "#a78bfa")} onMouseLeave={(e) => (e.currentTarget.style.color = "#475569")}>{s.icon}</a>
            ))}
          </div>
        </div>
